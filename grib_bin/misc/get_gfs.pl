...
# 0.5x0.5 degree GFS
$URL='http://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs.$YYYY$MM$DD$HH/gfs.t${HH}z.pgrb2full.0p50.f${FHR3}';
##Example:
# http://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs.2018060406/gfs.t06z.pgrb2b.0p50.f048
#
